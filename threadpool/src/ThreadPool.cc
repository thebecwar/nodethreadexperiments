...
namespace threadpool
{
	...
	ThreadPool::ThreadPool(std::string& initScript) : m_initScript(initScript), m_async(this), m_dispatcher(this), m_runDispatcher(true)
	{
	...
	{
		// TODO: drain the completed queue, and call all the callbacks.
	}
}